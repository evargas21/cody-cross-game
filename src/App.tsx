            ...
            {gameState === 'setting' && (
                <form onSubmit={handleTargetWordSubmit} className="flex flex-col w-1/2 gap-3 mb-4">
                    ...
                    <button
                        ...
                        className="inline-flex items-center justify-center gap-2 rounded-md bg-gray-700 py-1.5 px-3 text-sm font-semibold text-white shadow-inner shadow-white/10 hover:bg-gray-600 focus:outline-none"
                    >
                        Comenzar juego
                    </button>
                </form>
                ...
                <div className="w-full max-w-md">
                    ...
                    {(gameState === 'won' || gameState === 'lost') && (
                        <button
                            type="button"
                            onClick={handleReset}
                            className="inline-flex w-full items-center justify-center gap-2 rounded-md bg-gray-700 py-1.5 px-3 text-sm font-semibold text-white shadow-inner shadow-white/10 hover:bg-gray-600 focus:outline-none"
                        >
                            Reiniciar el juego
                        </button>
                    )}
